...
def lesson_bell(lesson_date):
    ...
    bell.audio = "C:\\Users\\John\\Downloads\\lessonbell\\finalalarm.wav"
    bell.icon = "C:\\Users\\John\\Downloads\\lessonbell\\books.jpg"
    bell.message = "Wake up! Time for a lesson"
    bell.send()
    history_file_path = "C:\\Users\\John\\Downloads\\lessonbell\\lessonhistory.json"
    print(datetime.now())
...
def write_new_lesson_to_json():
    while True:
        ...
        dict_to_pass = {"Date":formatted_date_input,
                        "Time":raw_time_input}
        file_path = "C:\\Users\\John\\Downloads\\lessonbell\\addedlessons.json"
        existing_data = []
